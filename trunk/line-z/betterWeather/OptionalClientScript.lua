...
function updateWeatherAdvanced(WeatherOvernight, WeatherToday, WeatherTonight, WeatherTomorrowDay, WeatherTomorrowNight, WeatherDayAfterDay, WeatherDayAfterNight)
		...
		local result = screenH / screenW
		local Width = 0.26
        local Height = 0.40 
		result = math.floor(result * 1000)
		if result == 625 then --16:9
			Width = 0.22
		elseif 600 then --16:10
			Width = 0.20
		end
        local X = 0.40
        local Y = 0.40
	...
	if (WeatherOvernight ~= nil) then
			...
			guiCreateStaticImage(0.05,0.3,0.3,0.3, "betterWeather/img/Night/" .. NightWeatherIcons[WeatherOvernight] .. ".png", true, tabToday)
			...
			guiCreateStaticImage(0.35,0.3,0.3,0.3, "betterWeather/img/Day/" .. DayWeatherIcons[WeatherToday] .. ".png", true, tabToday)
			...
			guiCreateStaticImage( 0.65, 0.3, 0.3, 0.3, "betterWeather/img/Night/" .. NightWeatherIcons[WeatherTonight]  .. ".png", true, tabToday)
		...
		if (WeatherToday ~= nil) then
			...
			guiCreateStaticImage( 0.05, 0.3,0.3, 0.3, "betterWeather/img/Day/" .. DayWeatherIcons[WeatherToday] .. ".png", true, tabToday)
		...
		-- Only tonight's weather is to be shown, so we'll centre it.
			...
			guiCreateStaticImage( 0.35, 0.3, 0.3, 0.3, "betterWeather/img/Night/" .. NightWeatherIcons[WeatherTonight]  .. ".png", true, tabToday)
	...
	guiCreateStaticImage( 0.05, 0.3,0.3, 0.3, "betterWeather/img/Day/" .. DayWeatherIcons[WeatherTomorrowDay] .. ".png", true, tabTomorrow)
	guiCreateStaticImage( 0.65, 0.3,0.3, 0.3, "betterWeather/img/Night/" .. NightWeatherIcons[WeatherTomorrowNight]  .. ".png", true, tabTomorrow)
	...
	guiCreateStaticImage( 0.05, 0.3,0.3, 0.3, "betterWeather/img/Day/" .. DayWeatherIcons[WeatherDayAfterDay] .. ".png", true, tabDayAfter)
	guiCreateStaticImage( 0.65, 0.3, 0.3, 0.3, "betterWeather/img/Night/" .. NightWeatherIcons[WeatherDayAfterNight]  .. ".png", true, tabDayAfter)
...
function InitialiseWeatherReport()
	optional = xmlLoadFile("betterWeather/optional.xml")
